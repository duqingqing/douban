...
public class SendMesage  {
    public void send(String Accept)throws MessagingException {
        // 配置发送邮件的环境属性
...
//        message.setRecipient(RecipientType.CC, bcc);
        // 设置邮件标题
        message.setSubject("爬虫信息反馈");
        // 设置邮件的内容体
        message.setContent("<a href='http://www.XXX.org'>爬虫出现了问题，请即使解决</a>", "text/html;charset=UTF-8");
        // 发送邮件
